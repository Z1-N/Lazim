...
const Navbar = () => {
    return (
        <nav className="bg-gray-800 rounded-md  m-8">
                    ...
                    <div className="hidden md:block">
                        <div className="ml-4 flex items-center md:ml-6">
                            ...
                            <div className="ml-3 relative">
                                <div>
                                    <button className="max-w-xs bg-gray-800 rounded-full flex items-center text-sm focus:outline-none focus:shadow-solid" id="user-menu" aria-label="User menu" aria-haspopup="true">
                                        <img className="h-8 w-8 rounded-full" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR-H_USyjMgq6magY2wnfjpBZ0f1Ail_GUe_g&s" alt="User Avatar" />
                                    </button>
                                </div>
                            </div>
                        </div>
